...
2. Query your PDF collection (uses FAISS for fast retrieval):
   ...
   ```
   The assistant’s answer will include inline citations `[1]`, `[2]`, etc., referring to the context excerpts.  After the answer, a **References** list will map each citation number to the source file path and page (or section) number.
